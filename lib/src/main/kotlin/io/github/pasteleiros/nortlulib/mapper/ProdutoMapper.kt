...
fun ProdutoDto.toEntity() = ProdutoEntity(this.id,this.nome,this.descricao,this.categoria.toEntity(),this.valor,this.foto, this.ativo)
fun ProdutoEntity.toDto() = ProdutoDto(this.id,this.nome,this.descricao,this.categoria.toDto(),this.valor,this.foto, this.ativo)
