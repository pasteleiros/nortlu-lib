...
fun PedidoDto.toEntity() = PedidoEntity(this.id, this.items.toListDto(), this.usuario.toEntity(), this.formaPagamento, this.statusPedido,this.valorTotal)
fun PedidoEntity.toDto() = PedidoDto(this.id, this.items.toListEntity(), this.usuario.toDto(), this.formaPagamento, this.statusPedido,this.valorTotal)
